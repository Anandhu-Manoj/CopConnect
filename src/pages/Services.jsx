      ...
      >
        ...
        <div className="d-flex gap-5 mt-5 justify-content-center  ms-4">
          ...
          <Modal show={showMod} onHide={handleModClose}>
            <Modal.Header  style={{ background:
                "linear-gradient(135deg, #d9d9d9, #bfbfbf, #a6a6a6, #ffffff)",}} closeButton>
              <Modal.Title>Visit Inmates <i class="fa-solid fa-handshake-angle"></i></Modal.Title>
            </Modal.Header>
            <Modal.Body style={{ background:
                "linear-gradient(135deg, #d9d9d9, #bfbfbf, #a6a6a6, #ffffff)",}}>
             <input className="form-control w-100 mb-2" required type="text" placeholder="Enter your name" />
             <input className="form-control w-100 mb-2" required type="text" placeholder="Enter your fathers name" />
             <input className="form-control w-100 mb-2" required type="number" placeholder="Enter  your contact number" />
             <input className="form-control w-100 mb-2" required type="text" placeholder="Enter crminal name name" />
             <input className="form-control w-100 mb-2" required type="text" placeholder="Relatioship with criminal" />
             <input className="form-control w-100 mb-2" required type="date" placeholder="Date of visit" />
             <textarea className="form-control w-100 mb-2" required type="text" placeholder="Reason for visit" />
             <input className="form-control w-100 mb-2" required type="text" placeholder="Time of visit" />
